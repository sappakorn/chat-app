class ModelCustomerMessage {
  ...
  factory ModelCustomerMessage.fromJson(Map<String, dynamic> json) {
    return ModelCustomerMessage(
      id: json["id"] ?? "",
  ...
  static List<ModelCustomerMessage> listFromJson(List<dynamic> jsonList) {
    return jsonList.map((json) => ModelCustomerMessage.fromJson(json)).toList();
  }
}
